...
and navigate to the `MIPS examples directory <https://github.com/d-iii-s/msim/tree/master/examples/mips>`__,
...
:hoverxreftooltip:`Hint.<mips-hint-20>` :hoverxreftooltip:`Solution.<mips-solution-21>`
