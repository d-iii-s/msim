...
#define cp0_index_index \
	((pr->cp0[ CP0_Index] & cp0_index_index_mask) >> \
	 cp0_index_index_shift)
#define cp0_index_res \
	((pr->cp0[ CP0_Index] & cp0_index_res_mask) >> cp0_index_res_shift)
#define cp0_index_p \
	((pr->cp0[ CP0_Index] & cp0_index_p_mask) >> cp0_index_p_shift)
/*
#define cp0__W	M
 */
...
#define cp0_random_random \
	((pr->cp0[ CP0_Random] & cp0_random_random_mask) >> \
	 cp0_random_random_shift)
#define cp0_random_res \
	((pr->cp0[ CP0_Random] & cp0_random_res_mask) >> cp0_random_res_shift)
...
#define cp0_entrylo0_g \
	((pr->cp0[ CP0_EntryLo0] & cp0_entrylo_g_mask) >> cp0_entrylo_g_shift)
#define cp0_entrylo0_v \
	((pr->cp0[ CP0_EntryLo0] & cp0_entrylo_v_mask) >> cp0_entrylo_v_shift)
#define cp0_entrylo0_d \
	((pr->cp0[ CP0_EntryLo0] & cp0_entrylo_d_mask) >> cp0_entrylo_d_shift)
#define cp0_entrylo0_c \
	((pr->cp0[ CP0_EntryLo0] & cp0_entrylo_c_mask) >> cp0_entrylo_c_shift)
#define cp0_entrylo0_pfn \
	((pr->cp0[ CP0_EntryLo0] & cp0_entrylo_pfn_mask) >> \
	 cp0_entrylo_pfn_shift)
#define cp0_entrylo0_res1 \
	((pr->cp0[ CP0_EntryLo0] & cp0_entrylo_res1_mask) >> \
	 cp0_entrylo_res1_shift)

#define cp0_entrylo1_g \
	((pr->cp0[ CP0_EntryLo1] & cp0_entrylo_g_mask) >> cp0_entrylo_g_shift)
#define cp0_entrylo1_v \
	((pr->cp0[ CP0_EntryLo1] & cp0_entrylo_v_mask) >> cp0_entrylo_v_shift)
#define cp0_entrylo1_d \
	((pr->cp0[ CP0_EntryLo1] & cp0_entrylo_d_mask) >> cp0_entrylo_d_shift)
#define cp0_entrylo1_c \
	((pr->cp0[ CP0_EntryLo1] & cp0_entrylo_c_mask) >> cp0_entrylo_c_shift)
#define cp0_entrylo1_pfn \
	((pr->cp0[ CP0_EntryLo1] & cp0_entrylo_pfn_mask) >> \
	 cp0_entrylo_pfn_shift)
#define cp0_entrylo1_res1 \
	((pr->cp0[ CP0_EntryLo1] & cp0_entrylo_res1_mask) >> \
	 cp0_entrylo_res1_shift)
...
#define cp0_wired_w \
	((pr->cp0[ CP0_Wired] & cp0_wired_w_mask) >> cp0_wired_w_shift)
#define cp0_wired_res1 \
	((pr->cp0[ CP0_Wired] & cp0_wired_res1_mask) >> cp0_wired_res1_shift)
...
#define cp0_context_res1 \
	((pr->cp0[ CP0_Context] & cp0_context_res1_mask) >> \
	 cp0_context_res1_shift)
#define cp0_context_badvpn2 \
	((pr->cp0[ CP0_Context] & cp0_context_badvpn2_mask) >> \
	 cp0_context_badvpn2_shift)
#define cp0_context_ptebase \
	((pr->cp0[ CP0_Context] & cp0_context_ptebase_mask) >> \
...
#define cp0_pagemask_res1 \
	((pr->cp0[ CP0_PageMask] & cp0_pagemask_res1_mask) >> \
	 cp0_pagemask_res1_shift)
#define cp0_pagemask_mask \
	((pr->cp0[ CP0_PageMask] & cp0_pagemask_mask_mask) >> \
	 cp0_pagemask_mask_shift)
#define cp0_pagemask_res2 \
	((pr->cp0[ CP0_PageMask] & cp0_pagemask_res2_mask) >> \
	 cp0_pagemask_res2_shift)
...
#define cp0_cause_res1 \
	((pr->cp0[ CP0_Cause] & cp0_cause_res1_mask) >> cp0_cause_res1_shift)
#define cp0_cause_exccode \
	((pr->cp0[ CP0_Cause] & cp0_cause_exccode_mask) >> \
	 cp0_cause_exccode_shift)
#define cp0_cause_res2 \
	((pr->cp0[ CP0_Cause] & cp0_cause_res2_mask) >> cp0_cause_res2_shift)
#define cp0_cause_ip \
	((pr->cp0[ CP0_Cause] & cp0_cause_ip_mask) >> cp0_cause_ip_shift)
#define cp0_cause_res3 \
	((pr->cp0[ CP0_Cause] & cp0_cause_res3_mask) >> cp0_cause_res3_shift)
#define cp0_cause_ce \
	((pr->cp0[ CP0_Cause] & cp0_cause_ce_mask) >> cp0_cause_ce_shift)
#define cp0_cause_res4 \
	((pr->cp0[ CP0_Cause] & cp0_cause_res4_mask) >> cp0_cause_res4_shift)
#define cp0_cause_bd \
	((pr->cp0[ CP0_Cause] & cp0_cause_bd_mask) >> cp0_cause_bd_shift)
...
#define cp0_prid_rev \
	((pr->cp0[ CP0_PRId] & cp0_prid_rev_mask) >> cp0_prid_rev_shift)
#define cp0_prid_imp \
	((pr->cp0[ CP0_PRId] & cp0_prid_imp_mask) >> cp0_prid_imp_shift)
#define cp0_prid_res \
	((pr->cp0[ CP0_PRId] & cp0_prid_res_mask) >> cp0_prid_res_shift)
...
#define cp0_config_k0	\
	((pr->cp0[ CP0_Config] & cp0_config_k0_mask) >> cp0_config_k0_shift)
#define cp0_config_cu	\
	((pr->cp0[ CP0_Config] & cp0_config_cu_mask) >> cp0_config_cu_shift)
#define cp0_config_db	\
	((pr->cp0[ CP0_Config] & cp0_config_db_mask) >> cp0_config_db_shift)
#define cp0_config_b	\
	((pr->cp0[ CP0_Config] & cp0_config_b_mask) >> cp0_config_b_shift)
#define cp0_config_dc	\
	((pr->cp0[ CP0_Config] & cp0_config_dc_mask) >> cp0_config_dc_shift)
#define cp0_config_ic	\
	((pr->cp0[ CP0_Config] & cp0_config_ic_mask) >> cp0_config_ic_shift)
#define cp0_config_res	\
	((pr->cp0[ CP0_Config] & cp0_config_res_mask) >>cp0_config_res_shift)
#define cp0_config_eb	\
	((pr->cp0[ CP0_Config] & cp0_config_eb_mask) >> cp0_config_eb_shift)
#define cp0_config_em	\
	((pr->cp0[ CP0_Config] & cp0_config_em_mask) >> cp0_config_em_shift)
#define cp0_config_be	\
	((pr->cp0[ CP0_Config] & cp0_config_be_mask) >> cp0_config_be_shift)
#define cp0_config_sm	\
	((pr->cp0[ CP0_Config] & cp0_config_sm_mask) >> cp0_config_sm_shift)
#define cp0_config_sc	\
	((pr->cp0[ CP0_Config] & cp0_config_sc_mask) >> cp0_config_sc_shift)
#define cp0_config_ew	\
	((pr->cp0[ CP0_Config] & cp0_config_ew_mask) >> cp0_config_ew_shift)
#define cp0_config_sw	\
	((pr->cp0[ CP0_Config] & cp0_config_sw_mask) >> cp0_config_sw_shift)
#define cp0_config_ss	\
	((pr->cp0[ CP0_Config] & cp0_config_ss_mask) >> cp0_config_ss_shift)
#define cp0_config_sb	\
	((pr->cp0[ CP0_Config] & cp0_config_sb_mask) >> cp0_config_sb_shift)
#define cp0_config_ep	\
	((pr->cp0[ CP0_Config] & cp0_config_ep_mask) >> cp0_config_ep_shift)
#define cp0_config_ec	\
	((pr->cp0[ CP0_Config] & cp0_config_ec_mask) >> cp0_config_ec_shift)
#define cp0_config_cm	\
	((pr->cp0[ CP0_Config] & cp0_config_cm_mask) >> cp0_config_cm_shift)
...
#define cp0_watchlo_w \
	((pr->cp0[ CP0_WatchLo] & cp0_watchlo_w_mask) >> cp0_watchlo_w_shift)
#define cp0_watchlo_r \
	((pr->cp0[ CP0_WatchLo] & cp0_watchlo_r_mask) >> cp0_watchlo_r_shift)
#define cp0_watchlo_res \
	((pr->cp0[ CP0_WatchLo] & cp0_watchlo_res_mask) >> cp0_watchlo_res_shift)
#define cp0_watchlo_paddr0 \
	((pr->cp0[ CP0_WatchLo] & cp0_watchlo_paddr0_mask) >> \
	 cp0_watchlo_paddr0_shift)
...
#define cp0_watchhi_paddr1 \
	((pr->cp0[ CP0_WatchHi] & cp0_watchhi_paddr1_mask) >> \
	 cp0_watchhi_paddr1_shift)
#define cp0_watchhi_res	\
	((pr->cp0[ CP0_WatchHi] & cp0_watchhi_res_mask) >> \
	 cp0_watchhi_res_shift)
...
#define cp0_ecc_ecc \
	((pr->cp0[ CP0_ECC] & cp0_ecc_ecc_mask) >> cp0_ecc_ecc_shift)
#define cp0_ecc_res \
	((pr->cp0[ CP0_ECC] & cp0_ecc_res_mask) >> cp0_ecc_res_shift)
...
#define cp0_xcontext_res1 \
	((pr->cp0[ CP0_XContext] & cp0_xcontext_res1_mask) >> \
	 cp0_xcontext_res1_shift)
#define cp0_xcontext_badvpn2 \
	((pr->cp0[ CP0_XContext] & cp0_xcontext_badvpn2_mask) >> \
	 cp0_xcontext_badvpn2_shift)
#define cp0_xcontext_r \
	((pr->cp0[ CP0_XContext] & cp0_xcontext_r_mask) >> \
	 cp0_xcontext_r_shift)
#define cp0_xcontext_ptebase \
	((pr->cp0[ CP0_XContext] & cp0_xcontext_ptebase_mask) >> \
	 cp0_xcontext_ptebase_shift)
...
struct processor_s
{
	...
	/* standard registers */
	int32_t regs[ 32], cp0[ 32];
	uint64_t fpregs[32];
	int32_t pcreg, pcnextreg, loreg, hireg;
	...
	int old_regs[ 32], old_cp0[ 32];
	int old_loreg, old_hireg;
	...
	long long tlb_refill, tlb_invalid, tlb_modified;
	long long intr[ 8];
};
