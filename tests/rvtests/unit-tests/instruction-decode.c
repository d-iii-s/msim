...
PCUT_TEST(op_add_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_add_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_sub_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sub_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_sll_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sll_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_slt_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_slt_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_sltu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sltu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_xor_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_xor_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_srl_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_srl_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_sra_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sra_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_or_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_or_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_and_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_and_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_mul_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_mul_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_mulh_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_mulh_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_mulhsu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_mulhsu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_mulhu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_mulhu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_div_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_div_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_divu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_divu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_rem_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_rem_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_remu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_remu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(op_illegal_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv32_illegal_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(branch_beq_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_beq_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(branch_bne_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_bne_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(branch_blt_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_blt_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(branch_bltu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_bltu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(branch_bge_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_bge_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(branch_bgeu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_bgeu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(jalr_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_jalr_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(jal_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_jal_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(lb_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_lb_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(lh_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_lh_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(lw_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_lw_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(lbu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_lbu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(lhu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_lhu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(sb_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sb_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(sh_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sh_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(sw_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sw_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(fence_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_fence_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(addi_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_addi_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(slti_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_slti_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(sltiu_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_sltiu_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(xori_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_xori_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(ori_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_ori_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(andi_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_andi_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(slli_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_slli_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(srli_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_srli_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(srai_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_srai_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(auipc_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_auipc_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(lr_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_lr_w_instr, rv32_instr_decode(instr));
}
...
PCUT_TEST(lui_decode)
{
    ...
    PCUT_ASSERT_EQUALS(rv_lui_instr, rv32_instr_decode(instr));
}
