...
sh-unknown-elf-gcc -m2e -fno-pic -fno-builtin -ffreestanding -nostdlib -nostdinc -c -o handler-wdt.raw handler-wdt.S
sh-unknown-elf-objcopy -O binary handler-wdt.raw handler-wdt.bin