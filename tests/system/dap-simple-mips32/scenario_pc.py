...
adp.send(WritePCRequest, arg0=DEFAULT_CPU, arg1=RST_VEC_VIRT + INSTR_LEN).expect_response(StatusOk)
...
for _ in range(2):
    ...
    # Rollback the PC
    adp.send(WritePCRequest, arg0=DEFAULT_CPU, arg1=RST_VEC_VIRT).expect_response(StatusOk)
