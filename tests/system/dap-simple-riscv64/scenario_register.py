...
adp.send(WriteGeneralRegisterRequest, arg0=DEFAULT_CPU, arg1=1, arg2=0x0123456789abcdef).expect_response(StatusOk)
adp.send(ReadGeneralRegisterRequest, arg0=DEFAULT_CPU, arg1=1).expect_response(StatusOk, arg0=0x0123456789abcdef)
